...
public class TableDemo extends javax.swing.JFrame {
    ...
    private void loadTable(){
        TableModel dataModel = new DefaultTableModel(loadRowData(), loadColumnName()); // RowData, ColumnName
        jTable1.setModel(dataModel);
    }
    
    private Object[] loadColumnName(){
        return new Object[]{"STT", "Họ tên", "email"};
    }
    
    private Object[][] loadRowData(){
        return new Object[][]{
            {1, "Nguyễn Văn Long", "abc@gmail.com"},
            {2, "Ngô Đình Thái", "xyz@gmail.com"}
        };
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //  thay đổi Look and Feel cho JFrame
                try {
